...
model_local = Ollama(model = "llama3.1:8b") # The default Llama 3.1 8b model. Quantization: 4-bit, Size: 4.7GB. Runs medium speed. Can do an entire prompt in 10-20s. Can use for interactive runs.
...
# model_local = Ollama(model = "phi3:latest") # A tiny but good Google Phi3 LLM. Quantization: 4-bit, Size: 2.3GB. Fast.
